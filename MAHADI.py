...
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     ...
     \033[1;91m➣ \033[1;91mFACEBOOK   :            OMI  HASAN AFRIDI
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;92m Total OK : \x1b[1;91m %s  \x1b[1;92mOMI _OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;91m Total CP :\x1b[1;91m   %s \x1b[1;91mOMI _CP.txt' % (H, P, str(len(cp))))
